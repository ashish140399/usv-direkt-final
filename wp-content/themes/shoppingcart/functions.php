...
function shoppingcart_woocommerce_add_to_cart_fragment( $fragments ) {
	ob_start();
	?>
			<div class="sx-cart-views"  style="position: relative;top: -6px;">
				<!--a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="wcmenucart-contents"-->
					<!--i class="fa fa-shopping-basket"></i-->
					<!--img src="http://localhost/direkt2/wp-content/uploads/2019/10/cart_icon.png">
				...
				<div class="nav-right_l">
					<div class="nav-right_l1">
						<img src="http://localhost/direkt2/wp-content/uploads/2019/10/smartphone-icon.png">

					</div>
					<div  class="nav-right_l2">
						<div style="position: relative;color: #15A4FA">Customer Service</div>
						<div style="position: relative;font-weight: 600;font-size: 16px;top: -3px">+49 02433 123456</div>
						
					</div>
				</div>
				<div class="nav-right_r">
					<div class="nav-right_r1">
						<span><span class="cart-value"><?php echo wp_kses_data ( WC()->cart->get_cart_contents_count() ); ?></span></span>
						<img src="http://localhost/direkt2/wp-content/uploads/2019/10/cart_icon.png">
					</div>
					<div class="nav-right_r2">
						<div style="position: relative;color: #15A4FA"><?php esc_html_e('Total', 'shoppingcart'); ?></div>
						<div style="position: relative;font-weight: 600;font-size: 16px;top: -3px"><?php echo wp_kses_data( WC()->cart->get_cart_subtotal() ); ?></div>
					</div>
				</div>
